...
\begin{table}[h!b!p!]\small
	...
	\begin{tabular}{| c | c | c | c | c | c | l | }
		...
		\hline
		Option & name & SimulationStop & type   & Time    & value & Simulation time. \\
		       &      &                &        & Frames  & value & Simulation number of frames. \\
		       &      &                &        &         &       & (Can be added to time stop \\ 
		       &      &                &        &         &       & criteria) \\ 
		\hline
		       &      & LogFiles       & type   & No      &       & \\
		...
		\hline
		       ...
		       &      &                &        &         &       & (Can be added to FPS) \\ 
		       &      &                & format & H5Part  &       & \\
		       &      &                &        & Tecplot &       & (Can be added to H5Part)\\
		\hline
		       &      & Timestep       & value  & Courant &       & (Time step recomputed)\\
		       &      &                &        & Fix     & value & (Time step computed at start) \\
		       &      &                &        & time [s] & & \\
		\hline
		       &      & Stabilization  & value  & time [s] & & \\
		\hline
	\end{tabular}
