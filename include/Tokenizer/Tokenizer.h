...
public:
     ...
     */
    const bool registerVariable(const std::string& name, const float& value);
     ...
     * otherwise.
     */
    const bool isVariable(const std::string& name) const;
     ...
     * found.
     */
    const float variable(const std::string& name) const;
     ...
     */
    const float solve(const std::string& eq);
