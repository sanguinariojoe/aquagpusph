...
class FigureController(FigureCanvas):
    ...
    def __init__(self):
        ...
        data = self.readFile('Fig30_filtered_1.dat')
        self.exp1_t = data[0]
        self.exp1_p = data[1]
        self.exp1_line, = self.ax.plot(self.exp1_t,
                                       ...
                                       linestyle='--',
                                       linewidth=2.0)
        data = self.readFile('Fig30_filtered_2.dat')
        self.exp2_t = data[0]
        self.exp2_p = data[1]
    ...
    def timerEvent(self, evt):
        ...
        for i in range(len(data[0])):
            self.p.append(data[8][i] / (rho * g * h))
            sumW = data[10][i]
...
if __name__ == '__main__':
    ...
    widget.setWindowTitle("Sensor 2")
    widget.show()
    sys.exit(app.exec_())
