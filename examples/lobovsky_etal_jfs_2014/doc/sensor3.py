...
class FigureController(FigureCanvas):
    ...
    def __init__(self):
        ...
        data = self.readFile('Fig31_filtered_3.dat')
        self.exp1_t = data[0]
        self.exp1_p = data[1]
        self.exp1_line, = self.ax.plot(self.exp1_t,
                                       ...
                                       linestyle='--',
                                       linewidth=2.0)
        data = self.readFile('Fig31_filtered_4.dat')
        self.exp2_t = data[0]
        self.exp2_p = data[1]
    ...
    def timerEvent(self, evt):
        ...
        for i in range(len(data[0])):
            self.p.append(data[15][i] / (rho * g * h))
            sumW = data[18][i]
...
if __name__ == '__main__':
    ...
    widget.setWindowTitle("Sensor 3")
    widget.show()
    sys.exit(app.exec_())
