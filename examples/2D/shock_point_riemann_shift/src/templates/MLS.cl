...
__kernel void entry(const __global unsigned int* iset,
                    ...
                    __global unsigned int* counter_mls_in,
                    ...
                    uint mls_imove)
{
    ...
    // Initialize the output
        ...
        #define _MLS_ mls[i]
        #define _COUNTER_MLS_IN_ counter_mls_in[i]
    #else
        #define _MLS_ mls_l[it]
        #define _COUNTER_MLS_IN_ counter_mls_in_l[it]
        __local matrix mls_l[LOCAL_MEM_SIZE];
        __local unsigned int counter_mls_in_l[LOCAL_MEM_SIZE];
    #endif
    _MLS_ = MAT_ZERO;
    _COUNTER_MLS_IN_ = 0;
    ...
    BEGIN_LOOP_OVER_NEIGHS(){
        ...
        mls[i] = _MLS_;
		counter_mls_in[i] = _COUNTER_MLS_IN_;
    #endif
}
