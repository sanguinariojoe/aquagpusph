 ...
 */
__kernel void simple(const __global unsigned int* restrict iset,
                     const __global int* restrict imove,
                     __global vec* restrict lap_p_corr,
 ...
 * @param N Number of particles.
 */
__kernel void full(const __global int* restrict imove,
 ...
 * @param N Number of particles.
 */
__kernel void full_mls(const __global int* restrict imove,
 ...
 * @param N Number of particles.
 */
__kernel void lapp(const __global int* restrict imove,
                   const __global vec* restrict r,
                   const __global float* restrict rho,
                   const __global float* restrict m,
                   const __global float* restrict p,
 ...
 * @param N Number of particles.
 */
__kernel void lapp_corr(const __global int* restrict imove,
                        const __global vec* restrict r,
                        const __global float* restrict rho,
                        const __global float* restrict m,
 ...
 */
__kernel void deltaSPH(const __global unsigned int* restrict iset,
                       const __global int* restrict imove,
                       const __global float* restrict rho,
                       const __global float* restrict lap_p,
                       __global float* restrict drhodt,
                       __constant float* restrict refd,
                       __constant float* restrict delta,
                       usize N,
                       float dt)
{
    const usize i = get_global_id(0);
