 ...
 *   - imove = 0 for sensors.
 *   - imove < 0 for boundary elements/particles.
 * @param iset_in Index of the set of particles.
 ...
 * @param tangent_in Tangent, \f$ \mathbf{t} \f$.
 ...
 * @param symmetry_n Normal of the symmetry plane. It is assumed as normalized.
 */
__kernel void feed(__global int* restrict imove_in,
                   __global int* restrict iset_in,
                   ...
                   __global vec* restrict normal_in,
                   __global vec* restrict tangent_in,
                   ...
                   vec symmetry_n)
{
    ...
    mirror_src[ii] = i;
    imove_in[ii] = imove_in[i];
    iset_in[ii] = iset_in[i];
    normal_in[ii].XYZ = normal_in[i].XYZ + reflection(normal_in[i].XYZ,
                                                      symmetry_n.XYZ);
    tangent_in[ii].XYZ = tangent_in[i].XYZ + reflection(tangent_in[i].XYZ,
                                                        symmetry_n.XYZ);
 ...
 * @param p Pressure (just in case it is an ISPH) \f$ p \f$.
 * @param N Number of particles.
 * @param symmetry_r Position of the symmetry plane.
 * @param symmetry_n Normal of the symmetry plane. It is assumed as normalized.
 */
__kernel void set(const __global usize* restrict mirror_src,
                  __global float* restrict m_in,
